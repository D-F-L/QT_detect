...
if __name__ == "__main__":
    ...
    output_txt = f"stream_output/tcp_realtime_cluster_result.txt"
    ...
    f_higher_bound = 400                      # 高频段，可以设置100开始测试，最终是1000的
    denoise_thresh = 0.1             
    line_channel = 0
    spec_freq_div = 20.0
    add_f_lower_bound = False
    ...
    # 接收第一个数据包获取采样率
    fs, pt_1s, vx_1s, vy_1s = receive_tcp_data(sock)
    print(f"[INFO] Received first packet, fs={fs}")
