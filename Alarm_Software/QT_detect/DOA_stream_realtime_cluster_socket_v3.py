...
class StreamLineDOAClusterProcessor:
    ...
    def _append_timing_row(self, row):
        ...
        file_exists = os.path.exists(self.timing_csv) and os.path.getsize(self.timing_csv) > 0
        with open(self.timing_csv, 'a', newline='', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    spec_freq_div = 20.0
    add_f_lower_bound = False
    track_match_max_dt = 180.0 #240.0
    track_match_max_df = 1.0
